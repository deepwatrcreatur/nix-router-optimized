...
- [ ] The feature has at least one validation path stronger than config-shape
      eval alone
- [ ] The observability surface does not overclaim maturity or HA behavior
